...
<body>
    ...
    <div class="container">
		<article class=" shadow col xs-12 col-sm-12 col-lg-6 col-md-9">
			<div class="contenu1">
				<img class="img-fluid" src="logo.jpg"><br>
				<h4 align="center">Accéder à ENSIAS e-learning</h4><br>
				<form action="acceuil_admin.php" method="GET">
					<input type="text" class="form-control test" placeholder="emailadmin" name="IdAdmin">
					<input type="password" class="form-control test" placeholder="Mot de passe" name="pass">
					<input type="submit">

					<button type="submit" class="btn btn-primary btn-sm login" onclick="log_admin()">Se Connecter</button>
					<br>
				</form>
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel"><img class="img-fluid logo" src="logo.jpg"></h5>
